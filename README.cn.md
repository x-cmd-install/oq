...
[![x-cmd/install — oq Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/oq.svg?lang=zh)](https://x-cmd.com/install/oq)
...
合计: **104,312** 行代码（覆盖前 5 种语言、共 **15** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Yaml | 65,173 | 1 | 3,499 | 8 |
| Json | 37,591 | 0 | 0 | 1 |
| Go | 1,548 | 76 | 320 | 5 |
| Markdown | 0 | 40 | 28 | 1 |
...
- **上游仓库**: <https://github.com/plutov/oq>
- **许可证**: MIT
...
- **Star**: 976 · **Fork**: 19 · **开放 issue**: 24 · **贡献者**: 6

## 累计统计

- **发布数**: 22 · **已合并 PR**: 21 · **开放 PR**: 1 · **已关闭 issue**: 20 · **开放 issue**: 4 · **提交数**: 42
...
| 360d | 2025-09-28 | 3 | 2 | 1 | 1 | 0 | 3 |
| last720d | 2024-10-03 | 22 | 21 | 1 | 20 | 4 | 42 |
...
oq 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `oq` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/oq.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T03:35:16Z._
